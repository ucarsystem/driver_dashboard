    ...
    if not user_id_input.strip():
        ...
        try:
            ...
            if filtered.empty:
                ...
                st.markdown("""<div style="width:100%; text-align:center; color:#3B3A3A; font-size:15px;">*📢인센티브 금액이 없는 경우 운수사에 문의하세요*</div>""", unsafe_allow_html=True)
...
pdf_path = os.path.join(file_dir, "굿드라이버_내 운전 리포트를 한눈에_개인정보보호정책안.pdf")
